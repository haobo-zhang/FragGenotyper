...
This project includes large files (e.g., models, datasets) managed using [Git Large File Storage (LFS)](https://git-lfs.github.com/).  
...
- **Windows**:  
  Download the installer from [https://git-lfs.com](https://git-lfs.com)
